...
def send_messasge(messages:List[ModelMessageDict],base_url:str = "http://192.168.19.127:8888/v1", api_key:str = 'EMPTY',
                  model_name:str = 'Qwen/Qwen3-VL-32B-Thinking',**kwargs) -> List[str]:
    '''
        Функция для отправки сообщениий в удаленную модель
    '''
    client = OpenAI( api_key=api_key,base_url=base_url, max_retries=1, **get_kwargs(kwargs,OpenAI)) 
